...
export default function ViewUsers() {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left my-3">
      <div>
        <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-transparent px-3 py-3  text-sm font-bold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
          View Users
          <ChevronDownIcon
            aria-hidden="true"
